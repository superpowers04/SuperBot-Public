...
function Message:_loadMore(data)
	...
	-- if data.referenced_message and data.referenced_message.author then
	-- 	if not self._mentioned_users then
	-- 		self._mentioned_users = {data.referenced_message.author.id}
	-- 	else
	-- 		if not self._mentioned_users[data.referenced_message.author.id] then
	-- 			insert(self._mentioned_users,data.referenced_message.author.id)
	-- 		end
	-- 	end
	-- end
...
--[=[@p stickers table Contains all the stickers in a message.]=]
function get.stickers(self)
	return self._stickers
end

--[=[@p interaction table A raw data table that contains all attachments that exist for this message. If
there are none, this table will not be present.]=]
